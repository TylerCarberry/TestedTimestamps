...
from audfprint import audfprint_analyze  # The actual analyzer class/code
from audfprint import audfprint_match  # Access to match functions, used in command line interface
from audfprint import hash_table  # My hash_table implementation
